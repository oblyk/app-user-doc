...
**Hauteur du secteur**  
La hauteur en mètres du secteur. Cette donnée sera utile pour le carnet de croix de vos grimpeurs et grimpeuses.
...
Vous pouvez ici stipuler le numéro du premier et du dernier relais de votre secteur. Au moment de renseigner vos voies, Oblyk vous suggérera les bons relais.

**Description**  
La description est informative. Elle n'est pour l'instant pas affichée à vos grimpeurs et grimpeuses.
...
Ces deux paramètres sont issus du paramétrage que vous avez fait au niveau de l'espace. Vous n'aurez sûrement pas besoin de les changer.
