...
La suppression d'un secteur est volontairement indisponible dans les options d'un secteur,  
...
Une fois sur la page de gestion des espaces et secteurs, trouvez le bouton avec trois points verticaux à côté du secteur à supprimer.  
