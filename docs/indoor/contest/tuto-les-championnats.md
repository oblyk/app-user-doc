...
Les championnats vous permettent de lier entre eux plusieurs contests que vous avez réalisés, ou que les salles de votre réseau ont faits.

Oblyk rapprochera les participants de vos différents contests par _"nom / prénom / date de naissance"_ pour établir un classement général de tous les contests de votre championnat.
...
Vous pouvez donner un nom, une présentation et définir comment vous voulez classer les différents contests de votre championnat.
...
{: .images }
[![Lier des contests](../../../assets/images/championnat-lier-un-contest.png)](../../../assets/images/championnat-lier-un-contest.png)
...
{: .images }
[![Lier des contests](../../../assets/images/championnat-contest-lie.png)](../../../assets/images/championnat-contest-lie.png)

## Faire la correspondance des catégories

Dans chacun de vos contests, vous avez pu avoir des catégories différentes, ou les avoir nommées différemment.  
...
Pour faire les correspondances, cliquez sur [CRÉER UNE CORRESPONDANCE](){: .light-btn } dans le bandeau **"Correspondance entre les catégories"**.
...
Cochez les catégories similaires dans les différents contests et donnez un nom final à votre catégorie.
...
Dans l'onglet résultat, vous aurez le classement général de vos différents contests !

{: .images }
[![Résultat](../../../assets/images/championnat-resultat.png)](../../../assets/images/championnat-resultat.png)

Vous pouvez partager la page publique avec vos compétiteurs pour qu'ils/elles puissent consulter leur classement général.
