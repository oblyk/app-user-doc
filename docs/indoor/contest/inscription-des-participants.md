...
La page publique de votre contest est la page destinée à vos participants. C'est depuis cette page qu'ils peuvent consulter les informations du contest, s'inscrire, renseigner leur résultat et voir leur classement.
...
Vous pouvez partager cette page avec vos participants.

Vous pouvez aussi télécharger un QR code à flasher qui se trouve sur le bouton (PLUS) dans la page d'administration.
...
Ce code est composé de son prénom + 3 lettres au hasard. Par exemple : lucien.abc
